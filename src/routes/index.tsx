    ...
    <PageShell>
      ...
      <section className="mt-28 sm:mt-40">
        <div className="container-editorial">
          <div className="section-oat relative overflow-hidden px-6 py-16 sm:px-12 sm:py-20">
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-espresso">How it works</p>
              <h2 className="mt-4 text-3xl font-bold leading-tight sm:text-5xl">
            ...
            <div className="mt-14 grid gap-6 sm:grid-cols-3">
              {[
                ...
                <motion.div
                  ...
                  className="glass-panel glass-sheen glass-float p-8"
                >
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-sage text-primary-foreground">
                    <s.icon className="h-5 w-5" strokeWidth={1.8} />
                  </div>
                  <p className="relative mt-6 text-xs font-semibold uppercase tracking-[0.2em] text-ink-soft">
                    Step {String(i + 1).padStart(2, "0")}
                  </p>
                  <h3 className="relative mt-2 text-xl font-bold">{s.title}</h3>
          ...
          <ul className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.li
                ...
                className="glass-panel glass-sheen glass-float flex items-center gap-4 rounded-[1.75rem] px-5 py-4"
              >
                <span className="relative grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-espresso text-background">
                  <f.icon className="h-4 w-4" strokeWidth={1.8} />
                </span>
                <span className="relative text-sm font-medium">{f.t}</span>
              </motion.li>
            ))}
          </ul>
        </div>
      ...
      <section className="mt-28 sm:mt-40">
        <div className="container-editorial">
          <motion.div
            ...
            className="section-matcha relative overflow-hidden px-8 py-16 sm:px-14 sm:py-24"
          >
            <div className="absolute -right-20 -top-24 h-72 w-72 rounded-full bg-apricot/40 blur-3xl" />
            <div className="absolute -bottom-24 -left-16 h-72 w-72 rounded-full bg-espresso/40 blur-3xl" />
            <div className="relative max-w-2xl">
              ...
              <Link to="/reserve" className="btn-primary mt-9">
